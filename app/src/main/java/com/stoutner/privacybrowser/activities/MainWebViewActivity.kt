...
class MainWebViewActivity : AppCompatActivity(), CreateBookmarkDialog.CreateBookmarkListener, CreateBookmarkFolderDialog.CreateBookmarkFolderListener, FontSizeDialog.UpdateFontSizeListener,
    ...
    override fun onPrepareOptionsMenu(menu: Menu): Boolean {
        ...
        var currentUserAgent = getString(R.string.user_agent_privacy_browser)
        var fontSize = 100
        ...
        when (currentUserAgent) {
            resources.getStringArray(R.array.user_agent_data)[0] -> {  // Privacy Browser.
                ...
                optionsUserAgentMenuItem.title = getString(R.string.options_user_agent) + " - " + getString(R.string.user_agent_privacy_browser)

                // Select the Privacy Browser radio box.
                optionsUserAgentPrivacyBrowserMenuItem.isChecked = true
            }
    ...
    override fun onOptionsItemSelected(menuItem: MenuItem): Boolean {
        ...
        return when (menuItem.itemId) {
            ...
            R.id.user_agent_privacy_browser -> {  // User Agent - Privacy Browser.
