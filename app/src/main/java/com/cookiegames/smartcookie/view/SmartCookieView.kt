...
/**
 * [SHIELDView] acts as a tab for the browser, handling WebView creation and handling logic, as
...
class SHIELDView(
    ...
    /**
     * Getter for the [SHIELDViewTitle] of the current LightningView instance.
     *
     * @return a NonNull instance of LightningViewTitle
     */
    val titleInfo: SHIELDViewTitle
    ...
    init {
        ...
        titleInfo = SHIELDViewTitle(activity)
        ...
        val tab = WebView(activity).also { webView = it }.apply {
            ...
            webChromeClient = SHIELDChromeClient(activity, this@SHIELDView)
     ...
     */
    private class WebViewHandler(view: SHIELDView) : Handler() {

        private val reference: WeakReference<SHIELDView> = WeakReference(view)
    ...
    companion object {
        ...
        private const val TAG = "SHIELDView"
