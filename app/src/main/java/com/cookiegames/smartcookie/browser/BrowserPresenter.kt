...
import com.cookiegames.smartcookie.view.SHIELDView
...
class BrowserPresenter(
    ...
    private var currentTab: SHIELDView? = null
    private var shouldClose: Boolean = false
    private var intented: SHIELDView? = null
     ...
     */
    fun tabChangeOccurred(tab: SHIELDView?) = tab?.let {
        view.notifyTabViewChanged(tabsModel.indexOfTab(it))
    }

    private fun onTabChanged(newTab: SHIELDView?) {
